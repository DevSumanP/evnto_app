...
mixin _$SplashState {
 ...
 SplashStatus get status; SplashNavigationResult? get nextRoute;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.status, status) || other.status == status)&&(identical(other.nextRoute, nextRoute) || other.nextRoute == nextRoute));
}


@override
int get hashCode => Object.hash(runtimeType,status,nextRoute);

@override
String toString() {
  return 'SplashState(status: $status, nextRoute: $nextRoute)';
}
...
@useResult
$Res call({
 SplashStatus status, SplashNavigationResult? nextRoute
});
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? nextRoute = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as SplashStatus,nextRoute: freezed == nextRoute ? _self.nextRoute : nextRoute // ignore: cast_nullable_to_non_nullable
as SplashNavigationResult?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SplashStatus status,  SplashNavigationResult? nextRoute)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.status,_that.nextRoute);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SplashStatus status,  SplashNavigationResult? nextRoute)  $default,) {final _that = this;
switch (_that) {
case _SplashState():
return $default(_that.status,_that.nextRoute);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SplashStatus status,  SplashNavigationResult? nextRoute)?  $default,) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.status,_that.nextRoute);case _:
  return null;
...
class _SplashState implements SplashState {
  const _SplashState({this.status = SplashStatus.initial, this.nextRoute});
  

@override@JsonKey() final  SplashStatus status;
@override final  SplashNavigationResult? nextRoute;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.status, status) || other.status == status)&&(identical(other.nextRoute, nextRoute) || other.nextRoute == nextRoute));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? nextRoute = freezed,}) {
